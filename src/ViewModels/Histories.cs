...
namespace SourceGit.ViewModels
{
    public partial class Histories : ObservableObject
    {
        ...
        {
            get => _repo.EnableTopoOrderInHistory;
            set => _repo.EnableTopoOrderInHistory = value;
        }

        public bool HasShowFlag(Models.HistoryShowFlags flag)
        {
            return _repo.HistoryShowFlags.HasFlag(flag);
        }

        public void ToggleShowFlag(Models.HistoryShowFlags flag)
        {
            _repo.ToggleHistoryShowFlag(flag);
        }
