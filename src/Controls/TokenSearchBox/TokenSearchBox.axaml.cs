    ...
    public class TokenSearchBox : TemplatedControl
    {
        ...
        public void RemoveToken(TokenInstance token)
        {
            ...
            if (_persistentTokenSet.Contains(token.Raw))
            {
                ...
                var p = PersistentTokens.FirstOrDefault(x => x.Raw.Equals(token.Raw, StringComparison.OrdinalIgnoreCase));
                if (p != null)
        ...
        public void AddToken(string raw)
        {
            ...
            var opposite =
                SelectedTokens.FirstOrDefault(t => t.Raw.Equals(oppositeRaw, StringComparison.OrdinalIgnoreCase));
            if (opposite != null)
                SelectedTokens.Remove(opposite);

            if (SelectedTokens.All(t => !t.Raw.Equals(token, StringComparison.OrdinalIgnoreCase)))
            {
